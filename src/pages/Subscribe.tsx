...
import ScreenMockup from "../assets/code-mockup.png"
        ...
        <div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center">
            <div className="w-full max-w-[1100px] flex item-center justify-between mt-20 mx-auto">
                <div className="max-w-[640px]">
                    ...
                    <p className="mt-4 text-gray-200 leading-relaxed">Em apenas uma semana você vai dominar na prática uma das 
            ...
            <img src={ScreenMockup} alt="" className="mt-10" />
        </div>
    )
}
